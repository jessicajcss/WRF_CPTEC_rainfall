...
export_spatial(
  ...
  run_dt     = run_dt,
  output_dir = "outputs",
  formats    = c("geojson_nested"),
  #formats    = c("geojson_nested", "fgb", "shp"),
  # Pick the formats you need:
  #   "geojson_nested" — smallest GeoJSON, best for Lovable / web maps
  #   "fgb"            — binary FlatGeobuf, fastest to open in QGIS
  #   "shp"            — shapefile, best for ArcGIS / legacy tools
  verbose    = TRUE
)
